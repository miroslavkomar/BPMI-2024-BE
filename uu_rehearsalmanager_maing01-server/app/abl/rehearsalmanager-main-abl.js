...
const Errors = require("../api/errors/rehearsalmanager-main-error.js");
...
const logger = LoggerFactory.get("RehearsalmanagerMainAbl");

class RehearsalmanagerMainAbl {
  constructor() {
  ...
  async init(uri, dtoIn, session) {
    ...
    // HDS 2
    const schemas = ["rehearsalmanagerMain"];
    ...
    if (dtoIn.uuBtLocationUri) {
      ...
      const createAwscDtoIn = {
        name: "UuRehearsalmanager",
        typeCode: "uu-rehearsalmanager-maing01",
        location: location,
...
module.exports = new RehearsalmanagerMainAbl();
